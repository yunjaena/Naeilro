...
public class TourDetailImageRecyclerViewAdapter extends RecyclerView.Adapter<TourDetailImageRecyclerViewAdapter.ViewHolder> {
    ...
    public TourDetailImageRecyclerViewAdapter(Context context, List<TourInfo> tourInfoList) {
    ...
    @NonNull
    @Override
    public TourDetailImageRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TourDetailImageRecyclerViewAdapter.ViewHolder holder, int position) {
