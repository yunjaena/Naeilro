...
public class KoreanTourRetrofitManager {
    ...
    private KoreanTourRetrofitManager() {
    }

    public static KoreanTourRetrofitManager getInstance() {
        if (instance == null) {
            synchronized (KoreanTourRetrofitManager.class) {
                if (instance == null) {
                    instance = new KoreanTourRetrofitManager();
                }
            }
        }
        return instance;
