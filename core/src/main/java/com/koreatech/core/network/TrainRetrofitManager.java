...
public class TrainRetrofitManager {
    ...
    private TrainRetrofitManager() {
    }

    public static TrainRetrofitManager getInstance() {
        if (instance == null) {
            synchronized (TrainRetrofitManager.class) {
                if (instance == null) {
                    instance = new TrainRetrofitManager();
                }
            }
        }
        return instance;
